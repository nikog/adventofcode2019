...
function getCapture(result, i) {
  if (result !== undefined) {
    return Js_primitive.nullable_to_opt(Caml_array.caml_array_get(Js_primitive.valFromOption(result), i));
  }
...
function stringToCoords(wire) {
  var cursor = /* record */[/* contents : tuple */[
      0,
      0
    ]];
  var coords = $$Array.map((function (vector) {
          var result = re.exec(vector);
          var result$1 = result === null ? undefined : Js_primitive.some(result);
          ...
          if (direction !== undefined) {
            switch (direction) {
              case "D" : 
                  nextCoord = distance !== undefined ? sum(cursor[0], /* tuple */[
                          0,
...
function findIntersections(wireA, wireB) {
  var intersections = /* record */[/* contents : [] */0];
...
function distanceToIntersection(wire, coord) {
  ...
  var intersected = /* record */[/* contents */false];
  $$Array.iteri((function (ia, a) {
          var match = intersected[0];
          if (ia !== 0 && !match) {
...
function solutionPart1() {
  var wires = Fs.readFileSync(__dirname + "/input", "utf8").split((/\n/));
